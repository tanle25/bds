        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <textarea name="short_description"
                    ...
                    rows="3"
                    placeholder="Nhập mô tả ...">{{$page[0]->description ?? old('short_description')}}</textarea>
            ...
            <div class="form-group ">
                ...
                'name' => 'content',
                'current_input' => $page[0]->content ?? old('content') ?? ''
                ])
                @error('content')
                <div id="" class="error invalid-feedback d-block">
                        {{$message}}
